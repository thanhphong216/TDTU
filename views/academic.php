...
<body>
    ...
    <main class="main">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <h2 class="text-uppercase fw-bold education-title">Giáo dục</h2>
                    </div>
                </div>
        ...
        <section class="student-page">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="#">
                            <div class="text-center student-page-title">
                                <h2 class="text-uppercase fw-bold">Chuyen trang sinh vien TDTU</h2>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <!-- END SECTION STUDENT PAGE -->

        <!-- START SECTION STUDENT SERVICE -->
        <section class="student-service">
            <div class="container">
